...
(function() {
  var Crypt, DOM, Privatizer, p_request, popup, preg, purl, xhrQueue;
  ...
  self.port.on('p_response', function(response) {
    return xhrQueue.onloads[response.requestID](response);
  });

  p_request = function(obj) {
    obj.type = 'request';
